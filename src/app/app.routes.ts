...
export const routes: Routes = [
    {
        ...
        children: [
            ...
            {
                path: 'datatable',
                loadChildren: () => import('./pages/datatable/datatable.routes').then(m => m.DatatablesRoutes)
            },
            {
                path: 'theme-pages',
                loadChildren: () => import('./pages/theme-pages/theme-pages.routes').then(m => m.ThemePagesRoutes)
            },
            {
                path: 'ui-components',
    ...
    },
    {
        ...
        children: [
            ...
            {
                path: 'landingpage',
                loadChildren: () => import('./pages/theme-pages/landingpage/landingpage.routes').then(m => m.LandingPageRoutes)
            },
            {
                path: 'front-pages',
                loadChildren: () => import('./pages/front-pages/front-pages.routes').then(m => m.FrontPagesRoutes)
            }
        ]
    },
    {
